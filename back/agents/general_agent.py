...
async def get_general_agent() -> str:
    ...
    try:
        from utils.handoff_tools import transfer_to_research, transfer_to_report, ask_research_for_help, ask_report_for_help
        handoff_tools = [transfer_to_research, transfer_to_report, ask_research_for_help, ask_report_for_help]
        all_tools = tools + handoff_tools
        logger.info(f"Handoff tools added to General Agent: {len(handoff_tools)} tools")
    except ImportError:
